# An Unofficial Dockerfile for WSO2 Identity Server for Apple M1#
...
```
docker run --env WSO2_USER=<username> --env WSO2_USER_PASS=<yourpassword> -it -p 9443:9443 wso2is-for-m1:5.11.0-ubuntu
```