# An Unofficial Dockerfile for WSO2 API Manager for Apple M1 #
...
- Navigate to `<AM_DOCKERFILE_HOME>` directory. <br>
  Execute `docker build` command as shown below.
    + `docker build -t wso2am-for-m1:4.0.0-centos .`

> By default, the Docker image will prepackage the General Availability (GA) release version of the relevant WSO2 product.

##### 3. Running the Docker image.

- `docker run -it -p 9443:9443 wso2am-for-m1:4.0.0-centos`
...
```
docker run --env WSO2_USER=<username> --env WSO2_USER_PASS=<yourpassword> -it -p 9443:9443 wso2apim-for-m1:4.0.0-centos
```